...
for dungio in dungeons:
    ...
    while True:
        try:
           ...
           d_filename =  f'D:/mythic_run_data/mythicdata_{dungio}{upper}.csv'
           n_filename = f'D:/mythic_run_data/namedata_{dungio}{upper}.csv'
           lower +=1000
           upper +=1000
        ...
        #     with open('D:/mythic_run_data/pagenum.txt','w')as f:
        #         f.write(str(upper))
        #     break
...
# upper = 2000
# t = asyncio.run(main(lower,upper))
# # t[1].to_csv("3.2framediag.csv",index=False)
# flt = time.time()

# d_filename =  f'D:/mythic_run_data/mythicdata{upper}.csv'
# n_filename = f'D:/mythic_run_data/namedata{upper}.csv'

# t[0].to_csv(d_filename)
# t[1].to_csv(n_filename)
# print("file:", time.time()-flt)
# print(t)
# print("--- %s seconds ---" % (time.time() - start_time))
